...
def main(basis_number = 500):
	...
	#do ridge regression
	bayesian_ridge_regression = linear_model.BayesianRidge( n_iter = 5000)
	bayesian_ridge_regression.fit(transformed_molecular_features, molecule_energygap)
	
	# print bayesian_ridge_regression.coef_

	#calculate prediction accuracy on training data
	predicted_train_gap_energy = bayesian_ridge_regression.predict(transformed_molecular_features)
	...
	predicted_test_gapenergy = bayesian_ridge_regression.predict(transformed_test_features)
